                    ...
                    <tbody>
                        {leaders.map((leader, index) => (
                            <tr key={leader._id} className={index < 3 ? "bg-base-200 font-bold" : ""}>
                                ...
                                <td>
                                    {index === 0 && <FaTrophy className="text-yellow-500 text-3xl" />}
                                    {index === 1 && <FaTrophy className="text-gray-400 text-3xl" />}
                                    {index === 2 && <FaTrophy className="text-orange-600 text-3xl" />}
                                </td>
                            </tr>
                        ))}
                    </tbody>
